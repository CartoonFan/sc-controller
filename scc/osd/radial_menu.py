...
class RadialMenu(Menu):
        ...
        for index, i in enumerate(items):
            ...
            if icon_file:
                ...
                i.icon_widget.set_size_request(
                    self.ICON_SIZE * self.scale, self.ICON_SIZE * self.scale
                )
                ...
                # horisontal
                if SVGEditor.get_element(
                        i.widget, "menuitem_text") is not None:
    ...
    def show(self):
        ...
        X.shape_combine_mask(
            self.xdisplay, win, X.SHAPE_BOUNDING, 0, 0, pixmap, X.SHAPE_SET
        )
    ...
    def select(self, i):
        ...
        self.b.hilight(
            {"menuitem_" + i.id: "#" + self.config["osd_colors"]
             ["menuitem_hilight"],
             "text_" + i.id: "#" + self.config["osd_colors"]
