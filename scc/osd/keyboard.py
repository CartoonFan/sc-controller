    ...
    def on_draw(self, self2, ctx):
        ...
        for button in self.buttons:
            ...
            if button.label:
                ...
                ctx.move_to(x + w * 0.5 - width * 0.5 -
                            x_bearing, y + h * 0.5 + height * 0.3)
...
class Keyboard(OSDWindow, TimerManager):
   ...
   3  - erorr, failed to lock input stick, pad or button(s)
    ...
    def recolor(self):
        ...
        def _get(a): return SVGWidget.color_to_float(
    ...
    def on_daemon_connected(self, *a):
        ...
        if (c.get_flags() & ControllerFlags.HAS_CPAD) == 0:
            ...
            self.profile.buttons[SCButtons.CPADPRESS] = scc.osd.osk_actions.OSKPressAction(
                CPAD)
