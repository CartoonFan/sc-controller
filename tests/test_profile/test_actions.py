...
class TestActions(object):
    ...
    def test_axis(self):
        ...
        """
        if not isinstance(parser.from_json_data(
                {"action": "axis(ABS_X)"}), AxisAction):
            raise AssertionError
    ...
    def test_hats(self):
        ...
        if parser.from_json_data(
                {"action": "hatdown(ABS_X)"}).id != Axes.ABS_X:
            raise AssertionError
        if parser.from_json_data(
                {"action": "hatleft(ABS_X)"}).id != Axes.ABS_X:
            raise AssertionError
        if parser.from_json_data(
                {"action": "hatright(ABS_X)"}).id != Axes.ABS_X:
            raise AssertionError
        ...
        if parser.from_json_data(
                {"action": "hatup(ABS_X)"}).max != STICK_PAD_MIN + 1:
            raise AssertionError
        if parser.from_json_data(
                {"action": "hatdown(ABS_X)"}).max != STICK_PAD_MAX - 1:
            raise AssertionError
        if parser.from_json_data(
                {"action": "hatleft(ABS_X)"}).max != STICK_PAD_MIN + 1:
            raise AssertionError
        if (
    ...
    def test_mouse(self):
        ...
        """
        if parser.from_json_data(
                {"action": "mouse()"})._mouse_axis is not None:
            raise AssertionError
        if parser.from_json_data(
                {"action": "trackpad()"})._mouse_axis is not None:
            raise AssertionError
        if (
    ...
    def test_mouseabs(self):
        ...
        if (
            ...
            raise AssertionError
        if parser.from_json_data(
                {"action": "mouseabs()"})._mouse_axis is not None:
            raise AssertionError
    ...
    def test_area(self):
        ...
        if not isinstance(parser.from_json_data(
            ...
            raise AssertionError
        if parser.from_json_data(
                {"action": "area(10, 10, 50, 50)"}).coords != (
                10, 10, 50, 50,):
            raise AssertionError
    ...
    def test_relarea(self):
        ...
        if not isinstance(parser.from_json_data(
            ...
            raise AssertionError
        if parser.from_json_data(
                {"action": "relarea(10, 10, 50, 50)"}).coords != (
                10, 10, 50, 50,):
            raise AssertionError
    ...
    def test_winarea(self):
        ...
        if not isinstance(parser.from_json_data(
            ...
            raise AssertionError
        if parser.from_json_data(
                {"action": "winarea(10, 10, 50, 50)"}).coords != (
                10, 10, 50, 50,):
            raise AssertionError
    ...
    def test_relwinarea(self):
        ...
        if not isinstance(
            ...
            raise AssertionError
        if parser.from_json_data(
                {"action": "relwinarea(10, 10, 50, 50)"}).coords != (
                10, 10, 50, 50,):
            raise AssertionError
    ...
    def test_gyro(self):
        ...
        """
        if not isinstance(parser.from_json_data(
                {"action": "gyro(ABS_X)"}), GyroAction):
            raise AssertionError

        if parser.from_json_data(
                {"action": "gyro(ABS_X)"}).axes[0] != Axes.ABS_X:
            raise AssertionError
        if parser.from_json_data(
                {"action": "gyro(ABS_X)"}).axes[1] is not None:
            raise AssertionError
        if (
            ...
            raise AssertionError
        if parser.from_json_data(
                {"action": "gyro(ABS_X, ABS_Y)"}).axes[2] is not None:
            raise AssertionError
        if (parser.from_json_data(
                {"action": "gyro(ABS_X, ABS_Y, ABS_Z)"}).axes[2] != Axes.ABS_Z):
            raise AssertionError
    ...
    def test_gyroabs(self):
        ...
        if parser.from_json_data(
                {"action": "gyroabs(ABS_X)"}).axes[0] != Axes.ABS_X:
            raise AssertionError
        if parser.from_json_data(
                {"action": "gyroabs(ABS_X)"}).axes[1] is not None:
            raise AssertionError
        if (
        ...
        if (
            ...
            raise AssertionError
        if (parser.from_json_data(
                {"action": "gyroabs(ABS_X, ABS_Y, ABS_Z)"}).axes[2] != Axes.ABS_Z):
            raise AssertionError
    ...
    def test_tilt(self):
        ...
        if (parser.from_json_data(
                {"action": "tilt( button(KEY_D) )"}).actions[0].button != Keys.KEY_D):
            raise AssertionError
    ...
    def test_button(self):
        ...
        if parser.from_json_data(
                {"action": "button(KEY_X)"}).button != Keys.KEY_X:
            raise AssertionError
        if parser.from_json_data(
                {"action": "button(KEY_X)"}).button2 is not None:
            raise AssertionError
        if (
