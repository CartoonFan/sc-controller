...
class TestActions(object):
    ...
    def test_axis(self):
        ...
        """
        assert isinstance(parser.from_json_data({"action": "axis(ABS_X)"}),
                          AxisAction)
    ...
    def test_raxis(self):
        ...
        """
        assert isinstance(parser.from_json_data({"action": "raxis(ABS_X)"}),
                          RAxisAction)
        assert parser.from_json_data({
            "action": "raxis(ABS_X)"
        }).id == Axes.ABS_X
    ...
    def test_hats(self):
        ...
        """
        assert isinstance(parser.from_json_data({"action": "hatup(ABS_X)"}),
                          HatUpAction)
        assert isinstance(parser.from_json_data({"action": "hatdown(ABS_X)"}),
                          HatDownAction)
        assert isinstance(parser.from_json_data({"action": "hatleft(ABS_X)"}),
                          HatLeftAction)
        assert isinstance(parser.from_json_data({"action": "hatright(ABS_X)"}),
                          HatRightAction)
    ...
    def test_gyro(self):
        ...
        """
        assert isinstance(parser.from_json_data({"action": "gyro(ABS_X)"}),
                          GyroAction)
    ...
    def test_gyroabs(self):
        ...
        """
        assert isinstance(parser.from_json_data({"action": "gyroabs(ABS_X)"}),
                          GyroAbsAction)
    ...
    def test_resetgyro(self):
        ...
        """
        assert isinstance(parser.from_json_data({"action": "resetgyro()"}),
                          ResetGyroAction)
    ...
    def test_button(self):
        ...
        """
        assert isinstance(parser.from_json_data({"action": "button(KEY_X)"}),
                          ButtonAction)
